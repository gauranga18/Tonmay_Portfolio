...
export default function Home() {
  ...
  return (
    ...
    {/* LiquidEther background — bright colors so they glow through the overlay */}
    ...
    {/* Subtle dark overlay — just enough to keep text readable, not enough to kill the effect */}
    <div
    ...
    {/* Content */}
    <div className="relative z-[2] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 lg:py-2">
    ...
    Hi, I'm <span className="text-cyan-300 font-semibold">Tanmay</span>
    </h1>
    ...
    {/* Description */}
    <p className="text-base lg:text-lg text-white/85 leading-relaxed max-w-xl">
    ...
    <div className="text-sm text-white/75">Top 5% on</div>
    ...
    <div className="min-w-0">
    <div className="text-sm text-white/75">Project</div>
    ...
    <p className="text-xs text-white/75 text-center leading-relaxed">Clean, responsive, and user-focused</p>
    </div>
    ...
    <p className="text-xs text-white/75 text-center leading-relaxed">Simple, intuitive mobile experiences</p>
    </div>
    ...
    <p className="text-xs text-white/75 text-center leading-relaxed">Visual identity with impact</p>
    </div>
    </div>
    ...
    className="w-14 h-14 rounded-full bg-white/10 backdrop-blur-md border border-white/15 flex items-center justify-center hover:bg-white/25 hover:scale-110 transition-all duration-200"
